...
import { getId, getDescripcion, isActivo } from './TipoPersonaPage';

const TipoPersonaTable = ({ tipos, onEdit, onToggleStatus, onView }) => {
    if (!tipos || tipos.length === 0) {
        return (
            <div className="table-container">
                <div className="empty-state">
                    <p>No se encontraron tipos de persona.</p>
                </div>
            </div>
        );
    }
...
export default TipoPersonaTable;