...
import { ArrowLeft, UserSquare2, Activity, IdCard, CalendarDays } from 'lucide-react';
import { getId, getDescripcion, getEstado, getFechaCreacion, isActivo } from './TipoPersonaPage';
...
const TipoPersonaDetalle = ({ tipo, onBack }) => {
    if (!tipo) return null;
            ...
            <div className="detalle-card">
                <div className="detalle-card-header">
                    ...
                    <div>
                        ...
                        <p className="detalle-subtitle">Información detallada del tipo de persona</p>
                    </div>
...
export default TipoPersonaDetalle;