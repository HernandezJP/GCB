...
import { getId, getDescripcion, isActivo } from './TipoTelefonoPage';

const TipoTelefonoTable = ({ tipos, onEdit, onToggleStatus, onView }) => {
    if (!tipos || tipos.length === 0) {
        return (
            <div className="table-container">
                <div className="empty-state">
                    <p>No se encontraron tipos de teléfono.</p>
                </div>
            </div>
        );
    }
