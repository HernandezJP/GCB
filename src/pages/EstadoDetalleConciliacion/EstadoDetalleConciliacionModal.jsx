...
const INITIAL = { EDC_Descripcion: '' };

const EstadoDetalleConciliacionModal = ({ isOpen, onClose, onSave, estadoToEdit }) => {
            ...
            <div className="modal-card">
                <div className="modal-header">
                    <div className="modal-title-group">
                        ...
                        <h2>{estadoToEdit ? 'Editar Estado de Detalle Conciliacion' : 'Nuevo Estado de Detalle Conciliacion'}</h2>
                    </div>
                    ...
                    <div className="modal-body">
                        <div className="input-group">
                            ...
                            <input
                                ...
                                onChange={e => setFormData({ EDC_Descripcion: e.target.value })}
