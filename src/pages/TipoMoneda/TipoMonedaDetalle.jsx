        ...
        <div className="detalle-container">
            ...
            <div className="detalle-card">
                <div className="detalle-card-header">
                    ...
                    <div>
                        ...
                        <p className="detalle-subtitle">
                            Información detallada del tipo de moneda
                        </p>
                    </div>

                    <span
                        className={`status-pill ${
                            activo ? "pill-green" : "pill-red"
                        } detalle-status`}
                    >
                ...
                <div className="detalle-grid">
                    ...
                    <div className="detalle-item">
                        <div className="detalle-label">
                            <Coins size={14} /> Descripción
                        </div>

                        <div className="detalle-valor">
                            {getDescripcion(moneda) || "No disponible"}
                        </div>
                    </div>

                    <div className="detalle-item">
                        <div className="detalle-label">
                            <BadgeCheck size={14} /> Código ISO
                        </div>

                        <div className="detalle-valor">
                            <span className="iso-badge iso-lg">
                                {getCodigoIso(moneda) || "—"}
                            </span>
                        </div>
                    </div>
