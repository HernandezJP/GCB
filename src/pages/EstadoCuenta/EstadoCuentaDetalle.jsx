...
import { getId, getDescripcion, getFecha, isActivo } from './EstadoCuentaPage';

const EstadoCuentaDetalle = ({ estado, onBack }) => {
            ...
            <div className="detalle-card">
                <div className="detalle-card-header">
                    ...
                    <div>
                        ...
                        <p className="detalle-subtitle">Información detallada del estado de cuenta</p>
                    </div>
