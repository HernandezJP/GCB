...
import { getId, getDescripcion, isActivo, getFecha } from './EstadoCuentaPage';

const EstadoCuentaTable = ({ estados, onEdit, onToggleStatus, onView }) => {

    if (!estados || estados.length === 0) {
        return (
            <div className="table-container">
                <div className="empty-state">
                    <p>No se encontraron estados de cuenta.</p>
                </div>
            </div>
        );
    }
...
export default EstadoCuentaTable;