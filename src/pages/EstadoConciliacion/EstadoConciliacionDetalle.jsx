...
import { getId, getDescripcion, getFecha, isActivo } from './EstadoConciliacionPage';

const EstadoConciliacionDetalle = ({ estado, onBack }) => {
            ...
            <div className="detalle-card">
                <div className="detalle-card-header">
                    ...
                    <div>
                        ...
                        <p className="detalle-subtitle">Información detallada del estado de conciliacion</p>
                    </div>
...
export default EstadoConciliacionDetalle;