...
import { ArrowLeft, MapPin, Activity, IdCard, CalendarDays } from 'lucide-react';
import { getId, getDescripcion, getFechaCreacion, isActivo } from './TipoDireccionPage';
...
const TipoDireccionDetalle = ({ tipo, onBack }) => {
    if (!tipo) return null;
            ...
            <div className="detalle-card">
                <div className="detalle-card-header">
                    ...
                    <div>
                        ...
                        <p className="detalle-subtitle">Información detallada del tipo de dirección</p>
                    </div>
...
export default TipoDireccionDetalle;